...
#include "ti.etracker.TiEtrackerModule.h"
#include "ti.etracker.ExampleProxy.h"
	...
	namespace bindings {
		...
		BindEntry* TiModuleBindings::lookupGeneratedInit(const char* name, unsigned int length) {
			static BindEntry binds[] = {
				{"ti.etracker.ExampleProxy", ::ti::etracker::tietracker::ExampleProxy::bindProxy, ::ti::etracker::tietracker::ExampleProxy::dispose},
				{"ti.etracker.TiEtrackerModule", ::ti::etracker::TiEtrackerModule::bindProxy, ::ti::etracker::TiEtrackerModule::dispose}
			};
